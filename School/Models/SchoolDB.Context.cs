...
namespace School.Models
{
    ...
    public partial class SchoolDBEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetAllSubjectsEligible_Result> GetAllSubjectsEligible(Nullable<int> idTeacher)
        {
            var idTeacherParameter = idTeacher.HasValue ?
                new ObjectParameter("idTeacher", idTeacher) :
                new ObjectParameter("idTeacher", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetAllSubjectsEligible_Result>("GetAllSubjectsEligible", idTeacherParameter);
        }
        ...
        public virtual ObjectResult<GetMaterialsOfTeacher_Result> GetMaterialsOfTeacher(Nullable<int> idTeacher, Nullable<int> idSubject)
        {
            var idTeacherParameter = idTeacher.HasValue ?
                new ObjectParameter("IdTeacher", idTeacher) :
                new ObjectParameter("IdTeacher", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetMaterialsOfTeacher_Result>("GetMaterialsOfTeacher", idTeacherParameter, idSubjectParameter);
        }
        ...
        public virtual int TeacherAddMaterial(Nullable<int> idTeacher, Nullable<int> idSubject, Nullable<int> idClass, string link, string type)
        {
            var idTeacherParameter = idTeacher.HasValue ?
                new ObjectParameter("IdTeacher", idTeacher) :
                new ObjectParameter("IdTeacher", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("TeacherAddMaterial", idTeacherParameter, idSubjectParameter, idClassParameter, linkParameter, typeParameter);
        }
        ...
        public virtual int TeacherDeleteMaterial(Nullable<int> idMaterial)
        {
            var idMaterialParameter = idMaterial.HasValue ?
                new ObjectParameter("IdMaterial", idMaterial) :
                new ObjectParameter("IdMaterial", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("TeacherDeleteMaterial", idMaterialParameter);
        }
    
        public virtual ObjectResult<Nullable<int>> TeacherGetSituation(Nullable<int> idTeacher, Nullable<int> idStudent, string name, Nullable<int> term)
        {
            var idTeacherParameter = idTeacher.HasValue ?
                new ObjectParameter("idTeacher", idTeacher) :
                new ObjectParameter("idTeacher", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("TeacherGetSituation", idTeacherParameter, idStudentParameter, nameParameter, termParameter);
        }
        ...
        public virtual int TeacherModifyMaterial(Nullable<int> idMaterial, string link, string type)
        {
            var idMaterialParameter = idMaterial.HasValue ?
                new ObjectParameter("IdMaterial", idMaterial) :
                new ObjectParameter("IdMaterial", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("TeacherModifyMaterial", idMaterialParameter, linkParameter, typeParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> TeacherUpdateSituation(Nullable<int> idSubject, Nullable<int> idStudent)
        {
            var idSubjectParameter = idSubject.HasValue ?
                new ObjectParameter("IdSubject", idSubject) :
                new ObjectParameter("IdSubject", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("TeacherUpdateSituation", idSubjectParameter, idStudentParameter);
        }
